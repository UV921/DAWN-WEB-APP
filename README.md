...
- Study hours from marked Discord voice channels (Dawn’s own timer). Join a room and Dawn DMs you (only you can see it) asking what you’re doing. You can also start / label a session on the study card on Today.
...
In Discord you can use:
   ...
   - Join a study VC → Dawn DMs you **what are you doing?** (private) · set it on the Today study card · `/doing` to change it
