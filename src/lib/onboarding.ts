...
export const ONBOARDING_STEPS = [
  {
    ...
    hint: "Optional. Skip if you’d rather just set times.",
  ...
  },
  {
    ...
    hint: "Optional. Skip if this doesn’t help you.",
    type: "choice" as const,
    skippable: true,
    options: [
  ...
  {
    id: "focusHabit",
    prompt: "One habit to focus on first?",
    hint: "You can skip and keep Wake early.",
    type: "choice" as const,
    skippable: true,
    options: [
  ...
  },
  {
    ...
    hint: "Optional — skip if it feels like fluff.",
    type: "text" as const,
    skippable: true,
  ...
  },
  {
    ...
    hint: "Times are set. Start whenever you’re ready.",
