...
const FEATURES = [
  {
    ...
    alt: "Morning light on a phone — sign in to Dawn",
  },
  {
    id: "code",
    kicker: "Friends",
    ...
    alt: "Two friends sharing a morning at a desk",
  },
  {
    id: "board",
    kicker: "Board",
    ...
    alt: "A quiet desk at sunrise for habits and study",
  },
  {
    id: "study",
    kicker: "Hours",
    ...
    alt: "Headphones on in a sunlit study nook",
  },
] as const;
